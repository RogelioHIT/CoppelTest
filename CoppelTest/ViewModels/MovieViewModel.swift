...
struct MovieViewModel {
    ...
    static func getDummyModel() -> MovieViewModel {
        ...
        let dummyMovie = Movie(poster_path: "/7q448EVOnuE3gVAx24krzO7SNXM.jpg", backdrop_path: "/wcKFYIiVDvRURrzglV9kGu7fpfY.jpg", id: 31917, vote_average: 10.0, overview: "Based on the Pretty Little Liars series of young adult novels by Sara Shepard, the series follows the lives of four girls — Spencer, Hanna, Aria, and Emily — whose clique falls apart after the disappearance of their queen bee, Alison. One year later, they begin receiving messages from someone using the name \"A\" who threatens to expose their secrets — including long-hidden ones they thought only Alison knew.", release_date: "2016-08-03", original_language: "en", original_title: "Dummy #\(randomNumber)", video: false)
